...
// Defining SocialSettings interface locally to avoid complex imports
                            ...
                            <div className="order-2 lg:order-1">
                                ...
                                <div className="flex flex-wrap gap-4">
                                    {[
                                        ...
                                        <div
                                            key={social.name}
                                            className="group relative w-12 h-12 bg-slate-800/50 rounded-xl border border-white/5 flex items-center justify-center transition-all duration-300 hover:scale-110 hover:bg-slate-800 hover:border-purple-500/50 hover:shadow-[0_0_20px_rgba(168,85,247,0.3)] cursor-default"
                                        >
