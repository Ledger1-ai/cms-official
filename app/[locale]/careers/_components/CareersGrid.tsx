                        ...
                        <div className="grid grid-cols-1 gap-4">
                            {deptJobs.map((job: JobPosting) => (
                                <div
                                    ...
                                    className="group bg-[#0A0A0B] border border-white/10 rounded-xl p-4 flex flex-col md:flex-row md:items-center gap-6 hover:border-primary/50 transition-all cursor-pointer hover:shadow-lg hover:shadow-primary/5 relative overflow-hidden"
                                >
                                    <div className="absolute top-0 left-0 w-1 h-full bg-primary opacity-0 group-hover:opacity-100 transition-opacity" />

                                    {/* Job Image */}
                                    <div className="w-full md:w-48 aspect-video md:aspect-[4/3] rounded-lg overflow-hidden bg-slate-900 border border-white/5 relative flex-shrink-0">
                                        {job.coverImage ? (
                                            <NextImage
                                                src={job.coverImage}
                                                alt={job.title}
                                    ...
                                    <div className="md:pr-4">
                                        <Button variant="outline" className="w-full md:w-auto border-white/10 hover:bg-primary hover:text-white hover:border-primary transition-all group-hover:scale-105">
                                            View Details
                                        </Button>
                                    </div>
                                </div>
