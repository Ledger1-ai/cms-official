        ...
        <div className="relative w-full h-full p-3 md:p-6 flex flex-col gap-3 md:gap-4 overflow-hidden bg-black/40 backdrop-blur-xl rounded-2xl border border-white/10 shadow-2xl">
            ...
            <div className="flex flex-col sm:flex-row gap-2 sm:gap-3">
                {channels.map((channel, index) => (
                    ...
                    >
                        <channel.icon className={`w-4 h-4 sm:w-5 sm:h-5 ${channel.active ? "text-cyan-400" : "text-muted-foreground"}`} />
                        <span className={`text-[10px] sm:text-xs ${channel.active ? "text-cyan-400" : "text-muted-foreground"}`}>
                            {channel.label}
                        </span>
                    </motion.div>
                ))}
            ...
            >
                <div className="flex items-center justify-between mb-3">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <div className="text-xs sm:text-sm font-medium text-white">AI Sales Agent</div>
                    ...
                    {step >= 3 && step <= 5 && (
                        ...
                        >
                            ...
                            <span className="text-[10px] sm:text-xs text-cyan-400 font-mono">00:{String(step - 2).padStart(2, "0")}</span>
                        </motion.div>
                    )}
                </div>
            ...
            <div className="flex-1 flex flex-col gap-2 overflow-hidden">
                <div className="text-[10px] sm:text-xs font-bold text-cyan-500 uppercase tracking-wider">Live Conversation</div>
                ...
                <AnimatePresence>
                    {step >= 4 && (
                        ...
                        >
                            ...
                            <div className="bg-white/5 rounded-lg p-2 text-[10px] sm:text-xs text-muted-foreground max-w-[80%]">
                ...
                <AnimatePresence>
                    {step >= 5 && (
                        ...
                        >
                            <div className="bg-cyan-500/20 rounded-lg p-2 text-[10px] sm:text-xs text-cyan-200 max-w-[80%]">
                ...
                {step >= 6 && (
                    ...
                    >
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <div className="text-xs sm:text-sm font-bold text-white">Demo Scheduled</div>
                                <div className="text-[10px] sm:text-xs text-cyan-200">Tomorrow at 2:00 PM</div>
                            </div>
                        </div>
