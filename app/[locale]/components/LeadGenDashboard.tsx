    ...
    return (
        <div className="relative w-full h-full p-3 md:p-6 flex flex-col gap-3 md:gap-4 overflow-hidden bg-black/40 backdrop-blur-xl rounded-2xl border border-white/10 shadow-2xl">
            ...
            >
                <div className="flex items-center gap-3">
                    ...
                    <div className="flex-1">
                        <div className="text-xs sm:text-sm font-medium text-white mb-1">Web Scanning</div>
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-[10px] sm:text-xs text-yellow-400">{step >= 1 ? "Complete" : "Scanning..."}</span>
                        </div>
                    </div>
                </div>
                {step === 0 && (
            ...
            <div className="flex-1 flex flex-col gap-3">
                <div className="text-[10px] sm:text-xs font-bold text-yellow-500 uppercase tracking-wider">Discovered Leads</div>
                ...
                <AnimatePresence>
                    {leads.map((lead, index) => (
                        ...
                        >
                            ...
                            <div className="flex-1">
                                <div className="text-xs sm:text-sm font-medium text-white">{lead.company}</div>
                                <div className="text-[10px] sm:text-xs text-muted-foreground">Lead Score: {lead.score}%</div>
                            </div>
                            <div className={`px-2 py-0.5 rounded text-[10px] sm:text-xs font-medium ${lead.status === "hot"
                ...
                {step >= 5 && (
                    ...
                    >
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <div className="text-xs sm:text-sm font-bold text-white">Personalized Emails Sent</div>
                                <div className="text-[10px] sm:text-xs text-yellow-200">3 leads added to pipeline</div>
                            </div>
                        </div>
