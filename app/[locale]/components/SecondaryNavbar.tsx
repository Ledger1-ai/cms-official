...
export default function SecondaryNavbar() {
    ...
    return (
        <div className="bg-[#0A0A12] border-b border-white/5 py-2 block">
            <div className="container mx-auto px-4 lg:px-6 flex justify-center lg:justify-end items-center gap-6">
