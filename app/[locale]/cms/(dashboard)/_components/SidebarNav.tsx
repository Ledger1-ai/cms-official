...
import { LayoutDashboard, FileText, Briefcase, BookOpen, Settings, Globe, Users, Share2, Image as ImageIcon, Shield, Activity, GraduationCap, Mail, Contact2, LayoutTemplate, Grid, List, PlusCircle, Tags, Folder, Scan, Layout, ShoppingCart, PenTool, Wrench, Brain, User, File, Mic, Users2, FileInput, Search, LayoutTemplate as LucideLayoutTemplate, UserCheck, Loader2, Sparkles, Plus } from "lucide-react";
...
export const ICON_MAP: Record<string, React.ComponentType<{ className?: string }>> = {
    LayoutDashboard, FileText, Briefcase, BookOpen, Settings, Globe, Users, Share2, ImageIcon, Shield, Activity, GraduationCap, Mail, Contact2, LayoutTemplate, Grid, List, PlusCircle, Tags, Folder, Scan, Layout, ShoppingCart, PenTool, Wrench, Brain, User, File, Mic, Users2, FileInput, Search
};
