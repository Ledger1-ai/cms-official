...
export function DataTableRowActions<TData>({
  ...
  const [isToggleManagerOpen, setIsToggleManagerOpen] = useState(false);
    ...
    <>
      {isToggleManagerOpen && (
        <FeatureToggleManager
          ...
          onClose={() => setIsToggleManagerOpen(false)}
        />
      )}
      <AlertModal
        isOpen={open}
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end">
          ...
          <DropdownMenuItem onClick={() => setIsToggleManagerOpen(true)}>
