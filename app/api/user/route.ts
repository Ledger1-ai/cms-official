...
export async function POST(req: Request) {
  try {
    ...
    // Security Check: Public Registration
    const securityConfig = await prismadb.systemSecurityConfig.findFirst();
    if (securityConfig && !securityConfig.publicRegistration) {
